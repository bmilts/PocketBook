...
// Pops up warning or confirmation messages to user
        ...
        if (command.equals(DELETE_RECORD)) {
            ...
            builder.setView(view).setPositiveButton("OK", new DialogInterface.OnClickListener() {
                ...
                public void onClick(DialogInterface dialog, int which) {
                    ...
                    // Creating uri which contains record Id in order to allow delete
                    Uri uri = FriendsContract.Friends.buildFriendUri(String.valueOf(_id));
                    contentResolver.delete(uri, null, null); // (Uri, where clause, selection clause)
