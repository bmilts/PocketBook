...
// Makes opening and closing of databases much simpler
public class FriendsDatabase extends SQLiteOpenHelper {
    ...
    public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
        ...
        int version = oldVersion; // version running at this point in time

        if(version == 1){
            // Add extra fields to data base without deleting data
            version = 2;
