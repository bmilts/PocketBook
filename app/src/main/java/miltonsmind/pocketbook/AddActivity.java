...
public class AddActivity extends FragmentActivity {
        ...
        mButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(isValid()){
                    ...
                    // If process fails due to problem with data
                } else {

                    Toast.makeText(getApplicationContext(), "Please make sure you have entered valid information.", Toast.LENGTH_LONG).show();
    ...
    // If any fields are missed method will return false (Error)
